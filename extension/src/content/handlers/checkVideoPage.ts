...
// // Returns a new pageVideos object with the new videos from the page
...
// // Returns a new pageVideos object with the new videos from the video page
// export const checkVideoPage = async (pageVideos: Video[]): Promise<Video[]> => {
//   console.debug("scrapeVideoPage: Getting new videos from video page");

//   // Get the videoId from the page
//   const videoId = await getVideoId();

//   // Filter out any videos that are already in the pageVideos cache
//   const newVideoIds = videoId.filter((videoId) => {
//     return !pageVideos.find((pageVideo) => {
//       return pageVideo.videoId === videoId;
//     });
//   });
