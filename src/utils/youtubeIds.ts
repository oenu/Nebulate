...
export const slugIgnoreList = [
  ...
  "joescottmysteries",
  "mostinsanehijacking",
  "makingphilosophytube",
  "polyphonic-dark-side",
  "sarah-z-debater-theater",
  "thenewfword",
  "alex-goes-bananas",
  ...
  "worldsmiths",
  "technorama",
  "volksgeist-a-brief-history-of-music",
  "tipusultan",
  "avgts",
  "lostsaves",
  "kento-bento-pork-bun-murders",
  "polyphonic-epics",
  "ismathinvented",
  "brick-facade",
  "storymode",
  ...
  // "soyouhaventread",
  "thecoloradoproblem",
  "wendover-final-days-of-majuro",
  "wendover-airport",
  "astropro",
  "questionableadvice",
  "city-beautiful-best-city-awards",
  "greatcities",
  "planning-ancient-rome",
  "nextlevelworldbuilding",
  "fieldnotes",
  "badlawwordsgood",
  "blazingsaddles",
  "lindsayellislotr",
  "lindsayellistropicthunder",
  "lindsay-ellis-tom-hoopers-les-miserables",
  "d-day",
  "makingofsongbook",
  "originsofstealth",
  "mustard-underwater-aircraft-carriers",
  "becominghuman",
  "16daysinberlin",
  "wayuu",
  "trussissues",
